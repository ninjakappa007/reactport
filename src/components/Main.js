...
const Main = () => {
  return (
    <div className='mainbody lg:w-[1200px] w-[95%] min-h-[450px] lg:h-[550px] mx-auto rounded-lg'>
		...
		<div className="container lg:h-[550px] min-h-[450px] lg:w-[1200px] w-full flex justify-center items-center relative overflow-hidden rounded-lg px-4">
      <div className="card lg:w-[400px] lg:h-[250px] w-[280px] sm:w-[320px] min-h-[280px] sm:min-h-[300px]">
        ...
        Backend Developer at Amazon with 3.8+ years in Python and Django.</p>
        <a href="/assets/Ashutosh_Nayak_Python_Dev.pdf" target='_blank'>
